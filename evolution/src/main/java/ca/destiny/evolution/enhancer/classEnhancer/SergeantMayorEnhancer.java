...
public class SergeantMayorEnhancer extends CharacteristicsEnhancer {
    public SergeantMayorEnhancer(RandomNumberGeneratorService randomNumberGeneratorService) {
