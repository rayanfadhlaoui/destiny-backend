...
public class FirstLieutenantEnhancer extends CharacteristicsEnhancer {
    public FirstLieutenantEnhancer(RandomNumberGeneratorService randomNumberGeneratorService) {
