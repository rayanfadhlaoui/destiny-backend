...
public class WarrantOfficerEnhancer extends CharacteristicsEnhancer {
    public WarrantOfficerEnhancer(RandomNumberGeneratorService randomNumberGeneratorService) {
