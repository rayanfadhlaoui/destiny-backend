...
public class SecondClassBattle extends Battle {

    public SecondClassBattle(@Autowired OptimalWeaponFinder optimalWeaponFinder,
        ...
        super(SecondClassBattle.class, optimalWeaponFinder, randomNumberGeneratorService, simulationBattleExecutor);
    }

    @Test
    void secondClassesExam() throws IOException, URISyntaxException {
        exam("thirdClasses.json", "secondClasses.json", "thirdClasses.json", 30);
    }
