...
public class ViceAdmiralBattle extends Battle {

    public ViceAdmiralBattle(@Autowired OptimalWeaponFinder optimalWeaponFinder,
        ...
        super(ViceAdmiralBattle.class, optimalWeaponFinder, randomNumberGeneratorService, simulationBattleExecutor);
    }

    @Test
    void viceAdmiralsExam() throws IOException, URISyntaxException {
        exam("subAdmirals.json", "viceAdmirals.json", "subAdmirals.json", 40);
    }
