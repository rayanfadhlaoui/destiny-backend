...
public class FirstLieutenantBattle extends Battle {

    public FirstLieutenantBattle(@Autowired OptimalWeaponFinder optimalWeaponFinder,
        ...
        super(FirstLieutenantBattle.class, optimalWeaponFinder, randomNumberGeneratorService, simulationBattleExecutor);
    }

    @Test
    void firstLieutenantsExam() throws IOException, URISyntaxException {
        exam("lieutenants.json", "firstLieutenants.json", "lieutenants.json", 30);
    }
