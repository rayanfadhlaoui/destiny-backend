...
public class WarrantOfficerBattle extends Battle {

    public WarrantOfficerBattle(@Autowired OptimalWeaponFinder optimalWeaponFinder,
        ...
        super(WarrantOfficerBattle.class, optimalWeaponFinder, randomNumberGeneratorService, simulationBattleExecutor);
    }

    @Test
    void warrantOfficersExam() throws IOException, URISyntaxException {
        exam("sergeantsMayor.json", "warrantOfficers.json", "sergeantsMayor.json", 30);
    }
