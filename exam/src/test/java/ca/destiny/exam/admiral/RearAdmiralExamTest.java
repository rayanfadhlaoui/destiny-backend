...
public class RearAdmiralExamTest extends AbstractExamTest {

    public RearAdmiralExamTest(@Autowired RearAdmiralExam rearAdmiralExam) {
        super(RearAdmiralExamTest.class, rearAdmiralExam);
    }

    @Test
    void rearAdmiralExam() throws IOException, URISyntaxException {
        exam("colonels.json", "rearAdmirals.json", "colonels.json", 18);
    }
}
