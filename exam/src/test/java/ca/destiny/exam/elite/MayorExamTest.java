...
public class MayorExamTest extends AbstractExamTest {

    public MayorExamTest(@Autowired MayorExam mayorExam) {
        super(MayorExamTest.class, mayorExam);
    }

    @Test
    void mayorExam() throws IOException, URISyntaxException {
        exam("firstLieutenants.json", "mayors.json", "firstLieutenants.json", 50);
    }
}
