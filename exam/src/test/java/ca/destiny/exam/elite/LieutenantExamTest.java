...
public class LieutenantExamTest extends AbstractExamTest {

    public LieutenantExamTest(@Autowired LieutenantExam lieutenantExam) {
        super(LieutenantExamTest.class, lieutenantExam);
    }

    @Test
    void lieutenantsExam() throws IOException, URISyntaxException {
        exam("juniorLieutenants.json", "lieutenants.json", "juniorLieutenants.json", 100);
    }
}
